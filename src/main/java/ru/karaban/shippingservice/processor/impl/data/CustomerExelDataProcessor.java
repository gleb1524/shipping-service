...
public class CustomerExelDataProcessor implements ExelDataProcessor {
    ...
    private final ExelService exelServiceCustomer;
    ...
    public void process(XSSFSheet sheet, int batchSize) {
        ...
        do {
            ...
            Future<List<Product>> result = taskExecutor.submit(() -> exelServiceCustomer.saveEntityFromExel(sheet, startRow, endRow));
            start += batchSize;
